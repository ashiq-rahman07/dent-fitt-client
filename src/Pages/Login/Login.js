    ...
    return (
        <div className=" w-2/5 mt-20 mx-auto bg-slate-700  p-8 space-y-3 rounded-xl dark:bg-gray-900 dark:text-gray-100">
            ...
            <div className="flex items-center pt-4 space-x-1">
                ...
                <p className="px-3 text-lg dark:text-gray-400">Login with social accounts</p>
                <div className="flex-1 h-px sm:w-16 dark:bg-gray-700"></div>
            </div>
            ...
            <p className="text-lg text-center sm:px-6 dark:text-gray-400">Don't have an account?
                <Link to='/register' className='hover:text-orange-700 font-medium'>Sign up</Link>
            </p>
        </div>
    );
};
